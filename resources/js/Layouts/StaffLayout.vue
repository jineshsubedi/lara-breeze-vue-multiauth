<script setup>
import StaffNav from "@/Layouts/Nav/Staff.vue"
import StaffSidebar from "@/Layouts/Sidebar/StaffSidebar.vue"
import Footer from "@/Layouts/Common/Footer.vue"
import FlashMessasge from "@/Layouts/Common/FlashMessasge.vue"
import {Link} from "@inertiajs/inertia-vue3"
import Floating from "@/Layouts/Common/Floating.vue"
...
<template>
    <div class="" id="jinesh">
        ...
        <header id="header" class="header fixed-top d-flex align-items-center">
            ...
            <Link :href="route('staffs.dashboard')" class="logo d-flex align-items-center">
