    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.resignationstaffs.index')"> ResignationStaff </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.resignationstaffs.edit', resignationstaff.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('admin.resignationstaffs.update', resignationstaff.id))
                                "
                            >
