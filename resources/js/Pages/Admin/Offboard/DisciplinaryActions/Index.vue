...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.disciplinaryactions.destroy", id));
    }
}
...
{
    terminateStaffRoute.value = route('admin.disciplinaryactions.terminatestaff', id)
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.disciplinaryactions.index')" :only="['disciplinaryactions']"> DisciplinaryAction </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('admin.disciplinaryactions.create')" class="btn btn-sm btn-outline-info">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" v-if="disciplinaryaction.termination == 0">
                                        <Link :href="route('admin.disciplinaryactions.show', disciplinaryaction.id)"
                                            class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-eye"></i>
                                        </Link>
                                        <Link :href="route('admin.disciplinaryactions.edit', disciplinaryaction.id)"
                                        ...
                                        <Link :href="route('admin.disciplinaryactions.holdstaff', disciplinaryaction.id)"
