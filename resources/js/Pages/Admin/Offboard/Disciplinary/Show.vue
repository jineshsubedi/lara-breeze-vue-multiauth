    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.disciplinary.index')"> DisciplinaryAction </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.disciplinary.show', disciplinaryaction.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr v-if="disciplinaryaction.justification_required == 1">
                                        ...
                                        <form
                                            @submit.prevent="
                                                form.put(route('admin.disciplinary.update', disciplinaryaction.id))
                                            "
                                        >
