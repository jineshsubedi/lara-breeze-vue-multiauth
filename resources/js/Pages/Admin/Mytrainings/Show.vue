    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.mytrainings.index')"> Training </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.mytrainings.show', training.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
            ...
            <CenterModal
                ...
                >
                    <form
                        ...
                        @submit.prevent="
                            form.post(route('admin.mytrainings.apply', training.id),{
                                preserveScroll: true,
