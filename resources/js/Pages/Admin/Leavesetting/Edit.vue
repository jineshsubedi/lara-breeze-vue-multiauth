...
const form = useForm({
    branch_id: props.leaveSetting.branch_id,
    quarter_day : props.leaveSetting.quarter_day,
    half_day : props.leaveSetting.half_day,
    sandwich : props.leaveSetting.sandwich,
    handover : props.leaveSetting.handover,
    s_approval : props.leaveSetting.s_approval,
    h_approval : props.leaveSetting.h_approval,
    m_approval : props.leaveSetting.m_approval,
    accrual_basis : props.leaveSetting.accrual_basis,
    hr_person : props.leaveSetting.hr_person,
    m_person : props.leaveSetting.m_person,
    leave_handler : props.leaveSetting.leave_handler,
    maximum_leave : props.leaveSetting.maximum_leave,
});

</script>
<template>
    <Head title="Leave Setting Edit" />
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.leave_setting.edit', leaveSetting.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('admin.leave_setting.update', leaveSetting.id))
                                "
                            >
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select v-model="form.hr_person" id="hr_person" class="form-control">
                                            <option v-for="(staff, index) in datas.staffs" :key="index" :value="staff.id">{{staff.name}}</option>
                                        </select>
                                        <div
                                            class="text-red-400 text-sm"
