...
function generateAttendance() {
    generateForm.post(route("admin.attendanceHandler.generate"), {
        preserveScroll: true,
        onSuccess: () => {
            // generateForm.reset();
...
function approveAttendance() {
    approveForm.post(route("admin.attendanceHandler.approve"), {
        preserveScroll: true,
        onSuccess: () => {
            // approveForm.reset();
        },
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.attendanceHandler.index')">
                        Attendance Handler
                    </Link>
                </li>
            </ol>
