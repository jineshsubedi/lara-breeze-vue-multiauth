...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        qform.delete(route("admin.surveys.deleteQuestion", id));
    }
}
...
{
    axios.post(route('admin.surveys.autocomplete', props.survey.id), 
        {
            term: term.value
        }
    )
...
{
    form.post(route('admin.surveys.postQuestion', props.survey.id))
}
...
{
    bulkForm.post(route('admin.surveys.bulkimport', id), {
        preserveScroll: true,
        onSuccess: () => {
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.surveys.getQuestion', survey.id)" :only="['questions']"> Questions </Link>
                </li>
            </ol>
        </template>
        <div class="">
