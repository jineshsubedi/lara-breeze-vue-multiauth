    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.adjustmentreasons.index')"> Adjustment Category </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.adjustmentreasons.create')"> Create </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.post(route('admin.adjustmentreasons.store'))
                                "
                            >
