...
import RateSupervisor from "@/Layouts/Common/RateSupervisor.vue"
import PerformanceRating from "@/Layouts/Common/PerformanceRating.vue"
...
<template> 
    ...
    <AdminLayout>
        ...
        <div class="col-md-12">
            <RateSupervisor :subordinate_rating="datas.subordinate_rating" :url="route('admin.subrating')" v-if="datas.subordinate_rating" />
            <PerformanceRating :performance_rating="datas.performance_rating" :url="route('admin.performancerating')" :staffs="datas.performance_staff" v-else-if="datas.performance_rating"/>
        </div>
    </AdminLayout>
</template>
<style>
