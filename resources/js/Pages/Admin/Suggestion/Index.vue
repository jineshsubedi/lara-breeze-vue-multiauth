...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.suggestions.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.suggestions.index')" :only="['suggestions']"> Suggestion </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right" v-if="!SuperAdmin">
                <Link :href="route('admin.suggestions.create')" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" >
                                        <Link :href="route('admin.suggestions.show', suggest.id)"
