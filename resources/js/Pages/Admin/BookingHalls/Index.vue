...
{
    Inertia.get(
        route('admin.bookinghalls.index'),
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.bookinghalls.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.bookinghalls.index')" :only="['bookinghalls']"> BookingHall </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('admin.bookinghalls.create')" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('admin.bookinghalls.edit', bookinghall.id)"
