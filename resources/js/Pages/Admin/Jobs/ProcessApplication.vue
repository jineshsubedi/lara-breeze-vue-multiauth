...
watch(
    ...
    throttle(function (value) {
        Inertia.get(
            route("admin.jobs.applicants.processing", [props.job.id, props.process.id]),
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.jobs.applicants.processing', [job.id, process.id])">
                        {{process.title}}
                    </Link>
                </li>
            </ol>
