    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.faculties.index')"> Faculty </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.faculties.edit', faculty.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('admin.faculties.update', faculty.id))
                                "
                            >
