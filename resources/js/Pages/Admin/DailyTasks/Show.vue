...
function approveBtn()
{
    if (confirm("Are you sure you want to Approve")) {
        form.post(route("admin.dailytasks.approveById", props.dailytask.id));
    }
}
    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.dailytasks.index')"> Daily Task </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.dailytasks.show', dailytask.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
