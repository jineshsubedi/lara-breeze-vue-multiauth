...
function  updateParticipant(id, training_id, user, status) {
    if (confirm("Are you sure?")) {
        Inertia.post(
            route('admin.trainings.actionParticipants', training_id),
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.trainings.participants', training.id)" :only="['participants']"> Training Participant </Link>
                </li>
            </ol>
        </template>
        <div class="container">
