...
{
    Inertia.get(
        route('admin.trainings.template.index', props.training.id),
...
function destroy(id, template_id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.trainings.template.destroy", [id, template_id]));
    }
}
    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.trainings.show', training.id)" :only="['training']"> Information </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.trainings.template.index', training.id)" :only="['templates']"> Templates </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('admin.trainings.template.create', training.id)" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('admin.trainings.getEvaluation', [training.id, template.id])"
                                        ...
                                        <Link :href="route('admin.trainings.template.edit', [training.id, template.id])"
