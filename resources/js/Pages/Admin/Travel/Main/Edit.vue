...
const form = useForm({
    type: props.travel.type,
    assigned_to: props.travel.assigned_to,
    from: props.travel.from,
    to: props.travel.to,
    purpose: props.travel.purpose,

    destination: props.travel.destination,

    assignment_type: props.travel.assignment_type,
    assignment_category: props.travel.assignment_category,
    mode_of_transport: props.travel.mode_of_transport,
    advance_required: props.travel.advance_required,

    road_sub: props.data.road_sub,
    payment_mode: props.data.payment_mode,
    reimbursement: props.data.reimbursement,
    position: props.data.position,
    grade: props.data.grade,

    per_diem_amount: props.travel.per_diem_amount,
    account_name: props.travel.account_name,
    account_number: props.travel.account_number,
    bank_name: props.travel.bank_name,
    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('admin.travels.index')"> Travel </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.travels.create')"> Create </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('admin.travels.update', travel.id))
                                "
                            >
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" v-model="form.position" id="position">
                                                    <option v-for="(level, lindex) in datas.level" :key="lindex" :value="level.id">{{level.title}}</option>
                                                </select>
                                                <div
                                                    class="text-red-400 text-sm"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" v-model="form.grade" id="grade">
                                                    <option v-for="(grade, gindex) in datas.grade" :key="gindex" :value="grade.id">{{grade.title}}</option>
                                                </select>
                                                <div
                                                    class="text-red-400 text-sm"
