...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.travels.destroy", id));
    }
}
    ...
    <AdminLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.travels.index')" :only="['travel']"> Travel </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('admin.travels.create')" class="btn btn-sm btn-outline-info">
        ...
        >
            <form
                ...
                @submit.prevent="
                    approveForm.post(route('admin.travels.approval'), {
