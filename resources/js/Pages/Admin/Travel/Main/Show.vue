...
function destroyExpense(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.travels.deleteTravelExpense", id), {
            preserveScroll: true
        });
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.travels.show', travel.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <Link :href="route('admin.travelplanners.create')" class="btn btn-sm btn-outline-info" style="float:right" v-if="travel.assigned_to == $page.props.auth.user.id && !planner">
            ...
            >
                <form
                    ...
                    @submit.prevent="
                        expenseForm.post(route('admin.travels.saveTravelExpense', travel.id), {
                            preserveScroll: true,
