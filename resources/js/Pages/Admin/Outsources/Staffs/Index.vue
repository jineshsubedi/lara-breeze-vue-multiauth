...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.outsources.staffs.destroy", [props.outsource.id, id]));
    }
}
let modalTitle = ref('');
let modalRoute = ref('');
function openCHecklistFormModel(id, title, checklist)
{
    ...
    modalRoute.value = route('admin.outsources.staffs.checklist',[props.outsource.id, id])
...
{
    Inertia.get(
        route('admin.outsources.staffs.index', props.outsource.id),
...
{
    Inertia.get(
        route('admin.outsources.staffs.export_staff', props.outsource.id),
        {
            preserveState: true,
            preserveScroll: true,
            replace: true,
...
{
    importForm.post(
        route('admin.outsources.staffs.import_staff', props.outsource.id),
        {
            preserveState: true,
            preserveScroll: true,
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.outsources.staffs.index', outsource.id)"> Staffs </Link>
                </li>
            </ol>
        </template>
        <div class="">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="text-right">
                            ...
                            &nbsp;
                            <Link :href="route('admin.outsources.staffs.create', outsource.id)" class="btn btn-sm btn-outline-info">
                                    ...
                                    <tbody>
                                        <tr v-for="(staff, sindex) in staffs.data" :key="sindex">
                                            ...
                                            <td class="btn-group">
                                                ...
                                                <Link :href="route('admin.outsources.staffs.show', [outsource.id, staff.id])"
                                                    class="btn btn-sm btn-outline-info">
                                                    <i class="bi bi-eye"></i>
                                                </Link>
                                                <Link :href="route('admin.outsources.staffs.edit', [outsource.id, staff.id])"
