...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("admin.outsources.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('admin.outsources.index')" :only="['outsources']"> Outsource </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                ...
                &nbsp;
                <Link :href="route('admin.outsources.create')" class="btn btn-sm btn-outline-info">
                                ...
                                >
                                    <td scope="row">
                                        <button class="btn btn-sm btn-outline-secondary">
                                            ...
                                            >
                                                <li>
                                                    <Link :href="route('admin.outsources.show', outsource.id)"
                                                ...
                                                <li>
                                                    <Link :href="route('admin.outsources.documents.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('admin.outsources.purchase.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('admin.outsources.staffs.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('admin.outsources.edit', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
