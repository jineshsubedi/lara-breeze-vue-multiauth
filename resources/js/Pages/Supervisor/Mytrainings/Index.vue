        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.mytrainings.index')" :only="['mytrainings']"> Trainings </Link>
                </li>
            </ol>
        </template>
        <div class="container">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <ReportLink
                                ...
                                "
                                :href="
                                    route('supervisor.mytrainings.index', [
                                        { type: 'mytraining' },
                                    ])
                                "
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td scope="row">
                                            <div class="btn-group">
                                                <Link :href="route('supervisor.mytrainings.show', mt.training.id)"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(template, tindex) in new_templates" :key="tindex">
                                            ...
                                            <td>
                                                <Link :href="route('supervisor.mytrainings.getEvaluation', template.id)"
