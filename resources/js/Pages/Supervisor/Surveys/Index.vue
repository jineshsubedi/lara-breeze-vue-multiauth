...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.surveys.destroy", id));
    }
}
...
function loadFilter() {
    Inertia.get(
        route("supervisor.surveys.index"),
        {
            branch: branch.value,
            title: title.value,
            from: from.value,
    ...
    <SupervisorLayout>
        ...
        <div class="container">
            <div class="text-right">
                <Link
                    :href="route('supervisor.surveys.create')"
                            ...
                            >
                                ...
                                <td scope="row">
                                    <button class="btn btn-sm btn-outline-secondary">
                                        ...
                                        >
                                            <li>
                                                <Link :href="route('supervisor.surveys.show', survey.id)"
                                            ...
                                            <li>
                                                <Link :href="route('supervisor.surveys.getQuestion', survey.id)"
                                                    class="dropdown-item d-flex align-items-center">
