...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        qform.delete(route("supervisor.surveys.deleteQuestion", id));
    }
}
...
{
    axios.post(route('supervisor.surveys.autocomplete', props.survey.id), 
        {
            term: term.value
        }
    )
...
{
    form.post(route('supervisor.surveys.postQuestion', props.survey.id))
}
...
{
    bulkForm.post(route('supervisor.surveys.bulkimport', id), {
        preserveScroll: true,
        onSuccess: () => {
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.surveys.index')"> Survey </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.surveys.getQuestion', survey.id)" :only="['questions']"> Questions </Link>
                </li>
            </ol>
        </template>
        <div class="">
