        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.bookings.create')" :only="['booking']"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <Link :href="route('supervisor.bookings.getParticipants', booking.id)" class="btn btn-sm btn-outline-primary" v-if="booking.booked_by == $page.props.auth.user.id"> Add Participants </Link>
                                        </td>
                                    </tr>
                            ...
                            <div class="mt-5" v-if="myparticipant != null">
                                ...
                                <form
                                    ...
                                    @submit.prevent="
                                        form.post(route('supervisor.bookings.updateStatus', myparticipant.id))
                                    "
                                >
