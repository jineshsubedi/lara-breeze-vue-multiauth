...
function destroy(id) {
    if (confirm("Are you sure you want to Remove")) {
        form.delete(route("supervisor.bookings.removeParticipants", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.bookings.getParticipants', booking.id)"> Participants </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    staffForm.post(route('supervisor.bookings.saveParticipants', booking.id))
                                "
                            >
                                <table class="table table-bordered">
                                    <thead>
