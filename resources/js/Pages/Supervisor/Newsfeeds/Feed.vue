...
function loadFilter() {
    axios
        .get(route("supervisor.newsfeeds.getall"), {
            params: {
                page: page.value,
            },
        })
...
function destroy(id, index)
{
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.newsfeeds.destroy", id), {
            preserveScroll: true,
...
{
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.newsfeeds.deleteComment", id), {
            preserveScroll: true,
...
{
    axios
        .get(route("supervisor.newsfeeds.hitlike", id), {
            params: {
                page: page.value,
            },
        })
    ...
    <div>
        <div class="card">
            <form 
                ...
                @submit.prevent="
                    createForm.post(route('supervisor.newsfeeds.store'), {
                        preserveScroll: true,
                        onSuccess: () => resetForm()
                    })
                "
            ...
            <form 
                class="form-horizontal"
                @submit.prevent="
                    eventForm.post(route('supervisor.newsfeeds.event'), {
                        preserveScroll: true,
                    ...
                    <div class="mt-3 commentSection" :id="'commentSection-'+feed.id" style="display:none;">
                        ...
                        <div class="comment-reply-box">
                            <form
                                class="form-horizontal"
                                @submit.prevent="
                                    commentForm.post(route('supervisor.newsfeeds.comment', feed.id), {
                                        preserveScroll: true,
