...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.compensatory.destroy", id));
    }
}
...
function compensatoryApproval(id) {
    ...
    approvalform.post(route("supervisor.compensatory.approval", id), {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            approvalform.reset()
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.compensatory.index')" :only="['compensatories']"> Compensatory </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.compensatory.create')" class="btn btn-sm btn-outline-info">
                                    ...
                                    >
                                        ...
                                        <td scope="row">
                                            <div class="btn-group" v-if="comp.status == '0'">
                                                <Link :href="route('supervisor.compensatory.edit', comp.id)"
