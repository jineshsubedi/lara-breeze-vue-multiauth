...
{
    Inertia.post(route('supervisor.users.update', props.user.id), {
        _method: 'put',
        title: form.title,
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.users.index')"> Staffs </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.users.edit', user.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
