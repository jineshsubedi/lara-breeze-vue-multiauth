...
function loadEditor()
{
    ...
    {
        axios.post(route('supervisor.letters.generation'), 
            {
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.letters.index')"> Letter </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.letters.generate')"> Generate Staff Letters </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- <form
                                ...
                                @submit.prevent="
                                    pdfForm.post(route('supervisor.letters.saveGenerate'))
                                "
                            > -->
