...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.letters.destroy", id));
    }
}
...
{
    Inertia.get(
        route('supervisor.letters.index'),
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.letters.index')" :only="['letters']"> Letter </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.letters.create')" class="btn btn-sm btn-outline-info">
                    <i class="bi bi-plus"></i> New Letter
                </Link>
                <Link :href="route('supervisor.letters.generate')" class="btn btn-sm btn-outline-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('supervisor.letters.edit', letter.id)"
