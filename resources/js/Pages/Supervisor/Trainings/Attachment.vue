...
function  destroy(id, training_id) {
    if (confirm("Are you sure?")) {
        form.delete(route("supervisor.trainings.deleteMaterials", [training_id, id]));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.trainings.getMaterials', training.id)" :only="['materials']"> Training Attachment </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            ...
            <CenterModal
                ...
                >
                    <form
                        ...
                        @submit.prevent="
                            aForm.post(route('supervisor.trainings.saveMaterials', training.id),{
                                preserveScroll: true,
