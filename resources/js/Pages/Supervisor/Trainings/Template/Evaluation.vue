        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.trainings.getEvaluation', [training.id, template.id])"> Evaluation Form </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form 
                                ...
                                @submit.prevent="
                                    form.post(route('supervisor.trainings.saveEvaluation', [training.id, template.id]))
                                "
                            >
