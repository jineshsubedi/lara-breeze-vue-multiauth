...
{
    Inertia.get(
        route('supervisor.trainings.template.index', props.training.id),
...
function destroy(id, template_id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.trainings.template.destroy", [id, template_id]));
    }
}
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.trainings.index')"> Training </Link>
                </li>
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.trainings.show', training.id)" :only="['training']"> Information </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.trainings.template.index', training.id)" :only="['templates']"> Templates </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.trainings.template.create', training.id)" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('supervisor.trainings.getEvaluation', [training.id, template.id])"
                                        ...
                                        <Link :href="route('supervisor.trainings.template.edit', [training.id, template.id])"
