...
function submitForm()
{
    Inertia.post(route('supervisor.abscondings.update', props.absconding.id), {
        _method: 'put',
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.abscondings.index')"> Absconding </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.abscondings.edit', absconding.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
