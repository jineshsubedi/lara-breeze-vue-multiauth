...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.abscondings.destroy", id));
    }
}
...
{
    terminateStaffRoute.value = route('supervisor.abscondings.terminatestaff', id)
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.abscondings.index')" :only="['abscondings']"> Absconding </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.abscondings.create')" class="btn btn-sm btn-outline-info">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" v-if="absconding.termination == 0">
                                        <Link :href="route('supervisor.abscondings.show', absconding.id)"
                                            class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-eye"></i>
                                        </Link>
                                        <Link :href="route('supervisor.abscondings.edit', absconding.id)"
                                        ...
                                        <Link :href="route('supervisor.abscondings.holdstaff', absconding.id)"
