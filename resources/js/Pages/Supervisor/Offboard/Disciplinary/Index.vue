        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.disciplinary.index')" :only="['disciplinaryactions']"> Disciplinary </Link>
                </li>
            </ol>
        </template>
        <div class="container">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn btn-group">
                                        <Link :href="route('supervisor.disciplinary.show', disciplinaryaction.id)"
