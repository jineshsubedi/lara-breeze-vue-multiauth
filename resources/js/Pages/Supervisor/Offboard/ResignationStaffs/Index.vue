...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.resignationstaffs.destroy", id));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.resignationstaffs.index')" :only="['resignationstaffs']"> ResignationStaff </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.resignationstaffs.create')" class="btn btn-sm btn-outline-info">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td scope="row">
                                        <div class="btn-group">
                                            <Link :href="route('supervisor.resignationstaffs.show', resignationstaff.id)"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </Link>
                                            <Link :href="route('supervisor.resignationstaffs.edit', resignationstaff.id)"
            ...
            >
                <form
                    class="form-horizontal"
                    @submit.prevent="
                        retractForm.post(route('supervisor.retraction.approval'), {
