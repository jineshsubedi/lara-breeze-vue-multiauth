...
const form = useForm({
    user_id: null,
    resignation_reason_id: null,
    resignation_type_id: null,
    resignation_detail: null,
});

</script>
<template>
    <Head title="ResignationStaff Create" />

    <SupervisorLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ResignationStaff Create
            </h2>
        </template>
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.resignationstaffs.index')"> ResignationStaff </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.resignationstaffs.create')"> Create </Link>
                </li>
            </ol>
        </template>
        <div class="">
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">New ResignationStaff</h5>
                            <form
                                class="form-horizontal"
                                @submit.prevent="
                                    form.post(route('supervisor.resignationstaffs.store'))
                                "
                            >
                                <div class="form-group row mb-3">
                                    ...
                                    >
                                    <div class="col-sm-10">
                                        <select class="form-control" v-model="form.user_id" id="user_id">
