...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.disciplinaryactions.destroy", id));
    }
}
...
{
    terminateStaffRoute.value = route('supervisor.disciplinaryactions.terminatestaff', id)
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.disciplinaryactions.index')" :only="['disciplinaryactions']"> DisciplinaryAction </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.disciplinaryactions.create')" class="btn btn-sm btn-outline-info">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" v-if="disciplinaryaction.termination == 0">
                                        <Link :href="route('supervisor.disciplinaryactions.show', disciplinaryaction.id)"
                                            class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-eye"></i>
                                        </Link>
                                        <Link :href="route('supervisor.disciplinaryactions.edit', disciplinaryaction.id)"
                                        ...
                                        <Link :href="route('supervisor.disciplinaryactions.holdstaff', disciplinaryaction.id)"
