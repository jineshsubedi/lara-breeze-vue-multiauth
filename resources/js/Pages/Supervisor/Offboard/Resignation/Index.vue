...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.resignations.destroy", id));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.resignations.index')" :only="['resignationstaffs']"> Resignations </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.resignations.create')" class="btn btn-sm btn-outline-info">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <ReportLink
                                ...
                                "
                                :href="
                                    route('supervisor.resignations.index', [
                                        { tab: null },
                                    ])
                                "
                                ...
                                >
                                    ...
                                    <td scope="row">
                                        <div class="btn-group" v-if="resignationstaff.supervisor_approval_status == 'pending'">
                                            <Link :href="route('supervisor.resignations.show', resignationstaff.id)"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </Link>
                                            <Link :href="route('supervisor.resignations.edit', resignationstaff.id)"
            ...
            >
                <form
                    ...
                    @submit.prevent="
                        approveForm.post(route('supervisor.resignations.approval'), {
            ...
            >
                <form
                    class="form-horizontal"
                    @submit.prevent="
                        retractForm.post(route('supervisor.retraction.save'), {
