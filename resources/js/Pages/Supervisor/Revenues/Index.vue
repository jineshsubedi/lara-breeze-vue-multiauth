...
{
    Inertia.get(
        route('supervisor.revenues.index'),
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.revenues.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.revenues.index')" :only="['revenues']"> Revenue </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right" v-if="RevenueHandler">
                <Link :href="route('supervisor.revenues.create')" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('supervisor.revenues.edit', revenue.id)"
