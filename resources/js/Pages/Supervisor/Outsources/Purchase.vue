...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.outsources.purchase.destroy", [props.outsource.id, id]));
    }
}

function submitOrderForm()
{
    form.post(route("supervisor.outsources.purchase.store", props.outsource.id), {
        preserveScroll: true,
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.outsources.purchase.index', outsource.id)"> Purchase Orders </Link>
                </li>
            </ol>
        </template>
        <div class="">
