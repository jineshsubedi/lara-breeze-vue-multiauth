    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.attendances.index')"> Attendance </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.attendances.show', attendance.id)"> Detail </Link>
                </li>
            </ol>
        </template>
        <div class="">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <form
                                                ...
                                                @submit.prevent="
                                                    form.put(route('supervisor.attendances.update', attendance.id))
                                                "
                                            >
