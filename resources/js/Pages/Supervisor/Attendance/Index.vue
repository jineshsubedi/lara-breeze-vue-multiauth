...
{
    Inertia.get(
        route('supervisor.attendances.index'),
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.attendances.index')" :only="['attendances', 'filters']"> Attendance </Link>
                </li>
            </ol>
        </template>
        <div class="container">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                >
                                    <td scope="row">
                                        <div class="btn-group">
                                            <Link :href="route('supervisor.attendances.show', attendance.id)"
