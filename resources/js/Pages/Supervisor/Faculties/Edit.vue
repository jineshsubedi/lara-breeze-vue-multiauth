    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.faculties.index')"> Faculty </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.faculties.edit', faculty.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('supervisor.faculties.update', faculty.id))
                                "
                            >
