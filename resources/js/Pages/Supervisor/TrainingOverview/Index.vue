    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.trainings.index')">
                        Trainings
                    </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.td.index')">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <ReportLink
                        ...
                        "
                        :href="route('supervisor.td.index', [{ type: 'overview' }])"
                ...
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="route('supervisor.td.index', [{ type: 'calendar' }])"
                        :only="[]"
                        >Calendar</ReportLink
                    >
                </li>
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="
                            route('supervisor.td.index', [{ type: 'evaluation' }])
                        "
                ...
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="route('supervisor.td.index', [{ type: 'cost' }])"
