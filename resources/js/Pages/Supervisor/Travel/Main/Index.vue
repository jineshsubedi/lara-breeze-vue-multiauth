...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.travels.destroy", id));
    }
}
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.travels.index')" :only="['travel']"> Travel </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('supervisor.travels.create')" class="btn btn-sm btn-outline-info">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item" v-if="SuperAdmin || HrHandler">
                    <ReportLink
                        ...
                        "
                        :href="
                            route('supervisor.travels.index', [
                                { tab: 'all' },
                            ])
                        "
        ...
        >
            <form
                ...
                @submit.prevent="
                    approveForm.post(route('supervisor.travels.approval'), {
