...
function destroyExpense(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("supervisor.travels.deleteTravelExpense", id), {
            preserveScroll: true
        });
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.travels.show', travel.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <Link :href="route('supervisor.travelplanners.create')" class="btn btn-sm btn-outline-info" style="float:right" v-if="travel.assigned_to == $page.props.auth.user.id && !planner">
            ...
            >
                <form
                    ...
                    @submit.prevent="
                        expenseForm.post(route('supervisor.travels.saveTravelExpense', travel.id), {
                            preserveScroll: true,
