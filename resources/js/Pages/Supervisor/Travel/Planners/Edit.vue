...
const form = useForm({
    travel_id: props.planner.travel_id,
    user_id: props.planner.visa ? props.planner.visa.user_id: null,
    department_id: props.planner.visa.department_id ? props.planner.visa.department_id : null,

    itinery: props.planner.itinery,
    road: props.planner.road,
    air: props.planner.air,
    hotel: props.planner.hotel,
});
function addItinery() {
    form.itinery.push({
        date: "",
    ...
    <SupervisorLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('supervisor.travelplanners.index')">
                        TravelPlanner
                    </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('supervisor.travelplanners.edit', planner.id)">
                        Edit
                    </Link>
                </li>
            </ol>
        ...
        <div class="">
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit TravelPlanner</h5>
                            <form
                                class="form-horizontal"
                                @submit.prevent="
                                    form.put(
                                        route('supervisor.travelplanners.update', planner.id)
                                    )
                                "
                            >
