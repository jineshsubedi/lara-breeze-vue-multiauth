...
{
    Inertia.get(
        route('staffs.outsources.export'),
        {
            preserveState: true,
            preserveScroll: true,
            replace: true,
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.outsources.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.outsources.index')" :only="['outsources']"> Outsource </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                ...
                &nbsp;
                <Link :href="route('staffs.outsources.create')" class="btn btn-sm btn-outline-info">
                                ...
                                >
                                    <td scope="row">
                                        <button class="btn btn-sm btn-outline-secondary">
                                            ...
                                            >
                                                <li>
                                                    <Link :href="route('staffs.outsources.show', outsource.id)"
                                                ...
                                                <li>
                                                    <Link :href="route('staffs.outsources.documents.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('staffs.outsources.purchase.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('staffs.outsources.staffs.index', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
                                                ...
                                                <li>
                                                    <Link :href="route('staffs.outsources.edit', outsource.id)"
                                                        class="dropdown-item d-flex align-items-center">
