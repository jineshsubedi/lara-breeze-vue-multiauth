...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.outsources.documents.destroy", [props.outsource.id, id]));
    }
}

function submitDocumentForm()
{
    form.post(route("staffs.outsources.documents.store", props.outsource.id), {
        preserveScroll: true,
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.outsources.documents.index', outsource.id)"> Documents </Link>
                </li>
            </ol>
        </template>
        <div class="">
