...
function loadFilter() {
    Inertia.get(
        route("staffs.attendanceHandler.index"),
        {
            staff: staff.value,
            from: from.value,
            to: to.value,
...
function exportAttendance() {
    exportForm.post(route("staffs.attendanceHandler.export"), {
        preserveScroll: true,
        onSuccess: () => {
...
function generateAttendance() {
    generateForm.post(route("staffs.attendanceHandler.generate"), {
        preserveScroll: true,
        onSuccess: () => {
            // generateForm.reset();
...
function approveAttendance() {
    approveForm.post(route("staffs.attendanceHandler.approve"), {
        preserveScroll: true,
        onSuccess: () => {
            // approveForm.reset();
        },
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.attendanceHandler.index')">
                        Attendance Handler
                    </Link>
                </li>
            </ol>
