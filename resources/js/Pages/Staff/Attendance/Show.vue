    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.attendances.index')"> Attendance </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.attendances.show', attendance.id)"> Detail </Link>
                </li>
            </ol>
        </template>
        <div class="">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <form
                                                ...
                                                @submit.prevent="
                                                    form.put(route('staffs.attendances.update', attendance.id))
                                                "
                                            >
