...
function destroy(id) {
    if (confirm("Are you sure you want to Remove")) {
        form.delete(route("staffs.bookings.removeParticipants", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.bookings.getParticipants', booking.id)"> Participants </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    staffForm.post(route('staffs.bookings.saveParticipants', booking.id))
                                "
                            >
                                <table class="table table-bordered">
                                    <thead>
