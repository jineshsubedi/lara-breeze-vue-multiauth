...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.letters.destroy", id));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.letters.index')" :only="['letters']"> Letter </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('staffs.letters.create')" class="btn btn-sm btn-outline-info">
                    <i class="bi bi-plus"></i> New Letter
                </Link>
                <Link :href="route('staffs.letters.generate')" class="btn btn-sm btn-outline-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('staffs.letters.edit', letter.id)"
