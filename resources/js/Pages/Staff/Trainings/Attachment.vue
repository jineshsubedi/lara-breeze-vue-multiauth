...
function  destroy(id, training_id) {
    if (confirm("Are you sure?")) {
        form.delete(route("staffs.trainings.deleteMaterials", [training_id, id]));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.trainings.getMaterials', training.id)" :only="['materials']"> Training Attachment </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            ...
            <CenterModal
                ...
                >
                    <form
                        ...
                        @submit.prevent="
                            aForm.post(route('staffs.trainings.saveMaterials', training.id),{
                                preserveScroll: true,
