...
function  destroy(id, training_id) {
    if (confirm("Are you sure?")) {
        form.delete(route("staffs.trainings.deleteCosts", [training_id, id]));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.trainings.getCosts', training.id)" :only="['costs']"> Training Costs </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            ...
            <CenterModal
                ...
                >
                    <form
                        ...
                        @submit.prevent="
                            cForm.post(route('staffs.trainings.saveCosts', training.id),{
                                preserveScroll: true,
