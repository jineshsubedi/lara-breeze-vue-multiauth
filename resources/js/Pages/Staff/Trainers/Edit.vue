...
function submitForm()
{
    Inertia.post(route('staffs.trainers.update', props.trainer.id), {
        _method: 'put',
        name: form.name,
        email: form.email,
    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.trainers.index')"> Trainer </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.trainers.edit', trainer.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
