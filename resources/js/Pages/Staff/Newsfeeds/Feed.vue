...
function loadFilter() {
    axios
        .get(route("staffs.newsfeeds.getall"), {
            params: {
                page: page.value,
            },
        })
...
{
    axios
        .get(route("staffs.newsfeeds.hitlike", id), {
            params: {
                page: page.value,
            },
        })
    ...
    <div>
        <div class="card">
            <form 
                ...
                @submit.prevent="
                    createForm.post(route('staffs.newsfeeds.store'), {
                        preserveScroll: true,
                        onSuccess: () => resetForm()
                    })
                "
            ...
            <form 
                class="form-horizontal"
                @submit.prevent="
                    eventForm.post(route('staffs.newsfeeds.event'), {
                        preserveScroll: true,
                    ...
                    <div class="mt-3 commentSection" :id="'commentSection-'+feed.id" style="display:none;">
                        ...
                        <div class="comment-reply-box">
                            <form
                                class="form-horizontal"
                                @submit.prevent="
                                    commentForm.post(route('staffs.newsfeeds.comment', feed.id), {
                                        preserveScroll: true,
