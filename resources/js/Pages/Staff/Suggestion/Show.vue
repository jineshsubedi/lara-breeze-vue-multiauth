...
function submitForm()
{
    form.put(route('staffs.suggestions.update', props.suggestion.id), {
    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.suggestions.index')"> Suggestion </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.suggestions.show', suggestion.id)"> Show </Link>
                </li>
            </ol>
        </template>
        <div class="">
