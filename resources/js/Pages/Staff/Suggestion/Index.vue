...
{
    Inertia.get(
        route('staffs.suggestions.index'),
...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.suggestions.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.suggestions.index')" :only="['suggestions']"> Suggestion </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right" v-if="!SuperAdmin">
                <Link :href="route('staffs.suggestions.create')" class="btn btn-sm btn-outline-info">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group">
                                        <Link :href="route('staffs.suggestions.show', suggest.id)"
