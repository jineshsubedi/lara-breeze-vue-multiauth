    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.trainings.index')">
                        Trainings
                    </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.td.index')">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <ReportLink
                        ...
                        "
                        :href="route('staffs.td.index', [{ type: 'overview' }])"
                ...
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="route('staffs.td.index', [{ type: 'calendar' }])"
                        :only="[]"
                        >Calendar</ReportLink
                    >
                </li>
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="
                            route('staffs.td.index', [{ type: 'evaluation' }])
                        "
                ...
                <li class="nav-item">
                    <ReportLink
                        ...
                        :href="route('staffs.td.index', [{ type: 'cost' }])"
