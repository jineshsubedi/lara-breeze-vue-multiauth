...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.surveys.destroy", id));
    }
}
    ...
    <StaffLayout>
        ...
        <div class="container">
            <div class="text-right">
                <Link
                    :href="route('staffs.surveys.create')"
                            ...
                            >
                                ...
                                <td scope="row">
                                    <button class="btn btn-sm btn-outline-secondary">
                                        ...
                                        >
                                            <li>
                                                <Link :href="route('staffs.surveys.show', survey.id)"
                                            ...
                                            <li>
                                                <Link :href="route('staffs.surveys.edit', survey.id)"
                                                    class="dropdown-item d-flex align-items-center">
                                            ...
                                            <li>
                                                <Link :href="route('staffs.surveys.getQuestion', survey.id)"
                                                    class="dropdown-item d-flex align-items-center">
                                            ...
                                            <li>
                                                <Link :href="route('staffs.surveys.participants', survey.id)"
                                                    class="dropdown-item d-flex align-items-center">
