    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.trainingprograms.index')"> TrainingProgram </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.trainingprograms.create')"> Create </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.post(route('staffs.trainingprograms.store'))
                                "
                            >
