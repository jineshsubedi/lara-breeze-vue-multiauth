...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.compensatory.destroy", id));
    }
}
...
function compensatoryApproval(id) {
    ...
    approvalform.post(route("staffs.compensatory.approval", id), {
        preserveScroll: true,
        preserveState: true,
        onSuccess: () => {
            approvalform.reset()
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.compensatory.index')" :only="['compensatories']"> Compensatory </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('staffs.compensatory.create')" class="btn btn-sm btn-outline-info">
                                    ...
                                    >
                                        ...
                                        <td scope="row">
                                            <div class="btn-group" v-if="comp.status == '0'">
                                                <Link :href="route('staffs.compensatory.edit', comp.id)"
