    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.compensatory.index')"> Compensatory </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.compensatory.edit', compensatoryoff.id)"> Edit </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.put(route('staffs.compensatory.update', compensatoryoff.id))
                                "
                            >
