    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.mytrainings.index', {type:'evaluation'})"> Templates </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.mytrainings.getEvaluation', template.id)"> Evaluation Form </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form 
                                ...
                                @submit.prevent="
                                    form.post(route('staffs.mytrainings.saveEvaluation', template.id))
                                "
                            >
