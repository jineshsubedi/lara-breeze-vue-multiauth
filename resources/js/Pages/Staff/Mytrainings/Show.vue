    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.mytrainings.index')"> Training </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.mytrainings.show', training.id)"> Information </Link>
                </li>
            </ol>
        </template>
        <div class="">
            ...
            <CenterModal
                ...
                >
                    <form
                        ...
                        @submit.prevent="
                            form.post(route('staffs.mytrainings.apply', training.id),{
                                preserveScroll: true,
