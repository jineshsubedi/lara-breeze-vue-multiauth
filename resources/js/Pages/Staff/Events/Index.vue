...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.events.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.events.index')" :only="['events']"> Event </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right" v-if="HrHandler||SuperAdmin">
                <Link :href="route('staffs.events.create')" class="btn btn-sm btn-outline-info">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" v-if="HrHandler||SuperAdmin">
                                        <Link :href="route('staffs.events.show', event.id)"
                                            class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-eye"></i>
                                        </Link>
                                        <Link :href="route('staffs.events.edit', event.id)"
