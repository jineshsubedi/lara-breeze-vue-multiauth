...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.subordinates.destroy", id));
    }
}
</script>
<template>
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.subordinates.index')" :only="['subordinates']"> Subordinate </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('staffs.subordinates.create')" class="btn btn-sm btn-outline-info">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <NavLink :active="filters.type == 'mynote' || filters.type == null" :href="route('staffs.subordinates.index',{type: 'mynote'})" >My Notes</NavLink>
                        </li>
                        <li class="nav-item">
                            <NavLink :active="filters.type == 'others'" :href="route('staffs.subordinates.index', {type:'others'})" >Subordinate Notes</NavLink>
                        </li>
                    </ul>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td scope="row">
                                        <div class="btn-group">
                                            <Link :href="route('staffs.subordinates.show', subordinate.id)"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </Link>
                                            <Link :href="route('staffs.subordinates.edit', subordinate.id)"
