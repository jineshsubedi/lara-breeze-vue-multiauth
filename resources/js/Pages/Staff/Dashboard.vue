...
{
    if(Ziggy.routes['staffs.attendances.index'])
    {
        Inertia.post(
            route('staffs.attendances.store'),
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="filter"> 
                            ...
                            <AddTodayTask :url="route('staffs.dailytasks.store')" :kras="datas.kra" />
                        </div>
                        <Link :href="route('staffs.dailytasks.index')" class="dtask">
