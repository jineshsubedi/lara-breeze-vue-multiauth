...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.abscondings.destroy", id));
    }
}
...
{
    terminateStaffRoute.value = route('staffs.abscondings.terminatestaff', id)
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.abscondings.index')" :only="['abscondings']"> Absconding </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('staffs.abscondings.create')" class="btn btn-sm btn-outline-info">
                            ...
                            >
                                ...
                                <td scope="row">
                                    <div class="btn-group" v-if="absconding.termination == 0">
                                        <Link :href="route('staffs.abscondings.show', absconding.id)"
                                            class="btn btn-sm btn-outline-info">
                                            <i class="bi bi-eye"></i>
                                        </Link>
                                        <Link :href="route('staffs.abscondings.edit', absconding.id)"
                                        ...
                                        <Link :href="route('staffs.abscondings.holdstaff', absconding.id)"
