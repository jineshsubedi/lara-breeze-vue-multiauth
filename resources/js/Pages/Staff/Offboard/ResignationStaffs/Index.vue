...
function destroy(id) {
    if (confirm("Are you sure you want to Delete")) {
        form.delete(route("staffs.resignationstaffs.destroy", id));
    }
}
        ...
        <template #breadcrum>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.resignationstaffs.index')" :only="['resignationstaffs']"> ResignationStaff </Link>
                </li>
            </ol>
        </template>
        <div class="container">
            <div class="text-right">
                <Link :href="route('staffs.resignationstaffs.create')" class="btn btn-sm btn-outline-info">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td scope="row">
                                        <div class="btn-group">
                                            <Link :href="route('staffs.resignationstaffs.show', resignationstaff.id)"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="bi bi-eye"></i>
                                            </Link>
                                            <Link :href="route('staffs.resignationstaffs.edit', resignationstaff.id)"
            ...
            >
                <form
                    class="form-horizontal"
                    @submit.prevent="
                        retractForm.post(route('staffs.retraction.approval'), {
