    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.bookingpurposes.index')"> BookingPurpose </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.bookingpurposes.create')"> Create </Link>
                </li>
            </ol>
        </template>
        <div class="">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form
                                ...
                                @submit.prevent="
                                    form.post(route('staffs.bookingpurposes.store'))
                                "
                            >
