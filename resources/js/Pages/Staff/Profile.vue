    ...
    <StaffLayout>
        ...
        <template #breadcrum>
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                    <Link :href="route('staffs.dashboard')">
                        Home
                    </Link>
                </li>
                <li class="breadcrumb-item active">
                    <Link :href="route('staffs.profile')">
                        User Profile
                    </Link>
                </li>
            </ol>
        ...
        <section class="section profile">
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <form @submit.prevent="avatarForm.post(route('staffs.updateAvatar'))" enctype="multipart/form-data" >
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <form class="form-horizontal" @submit.prevent="form.post(route('staffs.updateProfile'))">
