...
class OutsourceStaffController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return Inertia::render('Supervisor/Outsources/Staffs/Index', [
            'outsource' => $outsource,
            'staffs' => $staffs,
            'datas' => $datas,
    ...
    {
        $outsource = Outsource::findOrFail($id);
        return Inertia::render('Supervisor/Outsources/Staffs/Create', [
            'outsource' => $outsource,
    ...
    public function store(OutsourceStaffRequest $request, $id)
    {
        ...
        return redirect()->route('supervisor.outsources.staffs.index', [$outsource->id])->with('success', 'Staff Added');
    }
    ...
    public function show($id, $staff_id)
    {
        ...
        return Inertia::render('Supervisor/Outsources/Staffs/Show', [
            'outsource' => $outsource,
            'staff' => $staff,
        ]);
    }
    ...
    public function edit($id, $staff_id)
    {
        ...
        return Inertia::render('Supervisor/Outsources/Staffs/Edit', [
            'outsource' => $outsource,
            'status' => config('outsourceConstant.status'),
            'staff' => $staff,
        ]);
