...
class OutsourceController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Outsources/Index', [
    ...
    {
        return Inertia::render('Staff/Outsources/Create',[
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(OutsourceRequest $request)
    {
        ...
        return redirect()->route('staffs.outsources.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Outsource $outsource)
    {
        ...
        return Inertia::render('Staff/Outsources/Show', [
            'outsource' => $outsource
        ]);
    }
    ...
    {
        return Inertia::render('Staff/Outsources/Edit', [
            'outsource' => $outsource,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(OutsourceRequest $request, Outsource $outsource)
    {
        ...
        return redirect()->route('staffs.outsources.index')->with('success', 'Record Updated');
    }
