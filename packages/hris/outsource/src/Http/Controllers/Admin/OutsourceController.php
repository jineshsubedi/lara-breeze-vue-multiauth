...
class OutsourceController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Outsources/Index', [
    ...
    {
        return Inertia::render('Admin/Outsources/Create',[
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(OutsourceRequest $request)
    {
        ...
        return redirect()->route('admin.outsources.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Outsource $outsource)
    {
        ...
        return Inertia::render('Admin/Outsources/Show', [
            'outsource' => $outsource
        ]);
    }
    ...
    {
        return Inertia::render('Admin/Outsources/Edit', [
            'outsource' => $outsource,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(OutsourceRequest $request, Outsource $outsource)
    {
        ...
        return redirect()->route('admin.outsources.index')->with('success', 'Record Updated');
    }
