...
class HelpdeskController extends Controller
{
    ...
    {
        $data = $this->getData();
        return Inertia::render('Admin/Helpdesk/Create', [
            'data' => fn () => $data,
    ...
    public function store(HelpDeskRequest $request)
    {
        ...
        return redirect()->route('admin.helpdesks.index')->with('success', 'Help Desk Created Successfully!');
    }
    ...
    public function update(HelpDeskRequest $request, HelpDesk $helpdesk)
    {
        ...
        return redirect()->route('admin.helpdesks.index')->with('success', 'Help Desk Updated Successfully!');
    }
    ...
    {
        $helpdesk->delete();
        return redirect()->route('admin.helpdesks.index')->with('success', 'Help Desk Deleted Successfully');
    }
