...
class HelpdeskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Staff/Helpdesk/Index', [
    ...
    {
        $data = $this->getData();
        return Inertia::render('Staff/Helpdesk/Create', [
            'data' => fn () => $data,
    ...
    public function store(HelpDeskRequest $request)
    {
        ...
        return redirect()->route('staffs.helpdesks.index')->with('success', 'Help Desk Created Successfully!');
    }
    ...
    public function show(HelpDesk $helpdesk)
    {
        ...
        return Inertia::render('Staff/Helpdesk/Show', [
            'task' => fn () => $helpdesk,
        ]);
    }
    ...
    public function edit(HelpDesk $helpdesk)
    {
        ...
        return Inertia::render('Staff/Helpdesk/Edit', [
            'task' => fn () => $helpdesk,
            'data' => fn () => $data,
    ...
    public function update(HelpDeskRequest $request, HelpDesk $helpdesk)
    {
        ...
        return redirect()->route('staffs.helpdesks.index')->with('success', 'Help Desk Updated Successfully!');
    }
    ...
    {
        $helpdesk->delete();
        return redirect()->route('staffs.helpdesks.index')->with('success', 'Help Desk Deleted Successfully');
    }
