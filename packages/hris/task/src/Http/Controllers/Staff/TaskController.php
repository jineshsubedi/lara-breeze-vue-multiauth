...
class TaskController extends Controller
{
    ...
    {
        $data = $this->getData();
        return Inertia::render('Staff/Tasks/Create', [
            'data' => fn () => $data,
    ...
    public function store(TaskRequest $request)
    {
        ...
        Task::create($data);
        return redirect()->route('staffs.tasks.index')->with('success', 'Task Created Successfully!');
    }
    ...
    public function show(Task $task)
    {
        ...
        return Inertia::render('Staff/Tasks/Show', [
            'task' => fn () => $task,
            'data' => fn () => $data
        ]);
    }
    ...
    public function edit(Task $task)
    {
        ...
        return Inertia::render('Staff/Tasks/Edit', [
            'task' => fn () => $task,
            'data' => fn () => $data,
            'defBranch' => $defBranch
        ]);
    ...
    public function update(TaskRequest $request, Task $task)
    {
        ...
        return redirect()->route('staffs.tasks.index')->with('success', 'Task Updated Successfully!');
    }
    ...
    {
        $task->delete();
        return redirect()->route('staffs.tasks.index')->with('success', 'Task Deleted Successfully');
    }
