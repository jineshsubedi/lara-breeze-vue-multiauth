...
class SurveyAnswerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where('status', 1)
        ->paginate(10);
        return Inertia::render('Staff/Mysurveys/Index', [
            'surveys' => $surveys
        ]);
    }
    public function show($id)
    {
        ...
        {
            return Inertia::render('Staff/Mysurveys/Detail', [
                'survey' => $survey
            ]);
        }
        return Inertia::render('Staff/Mysurveys/Show', [
            'survey' => $survey
        ]);
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        DB::commit();
        return redirect()->route('staffs.mysurveys.index')->with('success', 'Survey Complete!');
    }
}
