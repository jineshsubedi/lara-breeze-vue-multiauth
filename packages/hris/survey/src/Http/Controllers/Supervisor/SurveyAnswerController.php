...
class SurveyAnswerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where('status', 1)
        ->paginate(10);
        return Inertia::render('Supervisor/Mysurveys/Index', [
            'surveys' => $surveys
        ]);
    }
    public function show($id)
    {
        ...
        {
            return Inertia::render('Supervisor/Mysurveys/Detail', [
                'survey' => $survey
            ]);
        }
        return Inertia::render('Supervisor/Mysurveys/Show', [
            'survey' => $survey
        ]);
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        DB::commit();
        return redirect()->route('supervisor.mysurveys.index')->with('success', 'Survey Complete!');
    }
}
