...
class TravelController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Travel/Main/Index', [
            'travels' => $travels,
    ...
    {
        return Inertia::render('Admin/Travel/Main/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(TravelRequest $request)
    {
        ...
        return redirect()->route('admin.travels.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Travel $travel)
    {
        ...
        return Inertia::render('Admin/Travel/Main/Show', [
            'travel' => $travel,
            'planner' => $planner,
            'expenses' => $expenses,
            'approval' => config('travelConstant.approval'),
    ...
    public function edit(Travel $travel)
    {
        ...
        return Inertia::render('Admin/Travel/Main/Edit', [
            'travel' => $travel,
            'data' => $data,
            'datas' => $this->getData()
        ]);
    ...
    public function update(TravelRequest $request, Travel $travel)
    {
        ...
        return redirect()->route('admin.travels.index')->with('success', 'Record Updated');
    }
