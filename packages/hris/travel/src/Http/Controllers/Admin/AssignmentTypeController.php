...
class AssignmentTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Travel/AssignmentTypes/Index', [
    ...
    {
        return Inertia::render('Admin/Travel/AssignmentTypes/Create');
    }
    ...
    public function store(AssignmentTypeRequest $request)
    {
        ...
        return redirect()->route('admin.assignmenttypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Travel/AssignmentTypes/Edit', [
    ...
    public function update(AssignmentTypeRequest $request, AssignmentType $assignmenttype)
    {
        ...
        return redirect()->route('admin.assignmenttypes.index')->with('success', 'Record Updated');
    }
