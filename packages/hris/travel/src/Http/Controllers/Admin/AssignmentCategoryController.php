...
class AssignmentCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Travel/AssignmentCategories/Index', [
    ...
    {
        return Inertia::render('Admin/Travel/AssignmentCategories/Create');
    }
    ...
    public function store(AssignmentCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.assignmentcategories.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Travel/AssignmentCategories/Edit', [
    ...
    public function update(AssignmentCategoryRequest $request, AssignmentCategory $assignmentcategory)
    {
        ...
        return redirect()->route('admin.assignmentcategories.index')->with('success', 'Record Updated');
    }
