...
class AssignmentCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Travel/AssignmentCategories/Index', [
    ...
    {
        return Inertia::render('Supervisor/Travel/AssignmentCategories/Create');
    }
    ...
    public function store(AssignmentCategoryRequest $request)
    {
        ...
        return redirect()->route('supervisor.assignmentcategories.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Travel/AssignmentCategories/Edit', [
    ...
    public function update(AssignmentCategoryRequest $request, AssignmentCategory $assignmentcategory)
    {
        ...
        return redirect()->route('supervisor.assignmentcategories.index')->with('success', 'Record Updated');
    }
