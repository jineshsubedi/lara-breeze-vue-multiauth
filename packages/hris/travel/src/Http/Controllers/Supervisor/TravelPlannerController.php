...
class TravelPlannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Travel/Planners/Index', [
    ...
    public function create()
    {
        $travels = Travel::where('assigned_to', auth()->id())
            ...
            ->get();
        return Inertia::render('Supervisor/Travel/Planners/Create',[
            'travels' => $travels,
    ...
    public function store(TravelPlannerRequest $request)
    {
        ...
        return redirect()->route('supervisor.travelplanners.index')->with('success', 'Record Added!');
    }
    ...
    public function edit(TravelPlanner $travelplanner)
    {
        ...
        $travels = Travel::where('assigned_to', auth()->id())
            ...
            ->select('id', 'unique_id', 'from', 'to')
            ->get();
        return Inertia::render('Supervisor/Travel/Planners/Edit', [
    ...
    public function update(TravelPlannerRequest $request, TravelPlanner $travelplanner)
    {
        ...
        return redirect()->route('supervisor.travelplanners.index')->with('success', 'Record Updated');
    }
