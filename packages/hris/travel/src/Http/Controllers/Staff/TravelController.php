...
class TravelController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Travel/Main/Index', [
            'travels' => $travels,
    ...
    {
        return Inertia::render('Staff/Travel/Main/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(TravelRequest $request)
    {
        ...
        return redirect()->route('staffs.travels.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Travel $travel)
    {
        ...
        return Inertia::render('Staff/Travel/Main/Show', [
            'travel' => $travel,
            'planner' => $planner,
            'expenses' => $expenses,
            'approval' => config('travelConstant.approval'),
    ...
    public function edit(Travel $travel)
    {
        ...
        return Inertia::render('Staff/Travel/Main/Edit', [
            'travel' => $travel,
            'data' => $data,
            'datas' => $this->getData()
        ]);
    ...
    public function update(TravelRequest $request, Travel $travel)
    {
        ...
        return redirect()->route('staffs.travels.index')->with('success', 'Record Updated');
    }
