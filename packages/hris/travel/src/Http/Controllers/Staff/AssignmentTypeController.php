...
class AssignmentTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Travel/AssignmentTypes/Index', [
    ...
    {
        return Inertia::render('Staff/Travel/AssignmentTypes/Create');
    }
    ...
    public function store(AssignmentTypeRequest $request)
    {
        ...
        return redirect()->route('staffs.assignmenttypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Travel/AssignmentTypes/Edit', [
    ...
    public function update(AssignmentTypeRequest $request, AssignmentType $assignmenttype)
    {
        ...
        return redirect()->route('staffs.assignmenttypes.index')->with('success', 'Record Updated');
    }
