...
class SubordinateController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Subordinates/Index', [
    ...
    {
        return Inertia::render('Admin/Subordinates/Create');
    }
    ...
    public function store(SubordinateRequest $request)
    {
        ...
        return redirect()->route('admin.subordinates.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Subordinate $subordinate)
    {
        ...
        return Inertia::render('Admin/Subordinates/Show', [
    ...
    {
        return Inertia::render('Admin/Subordinates/Edit', [
            'subordinate' => $subordinate
        ]);
    }
    ...
    public function update(SubordinateRequest $request, Subordinate $subordinate)
    {
        ...
        return redirect()->route('admin.subordinates.index')->with('success', 'Record Updated');
    }
