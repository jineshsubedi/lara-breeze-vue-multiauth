...
class SubordinateController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Subordinates/Index', [
    ...
    {
        return Inertia::render('Staff/Subordinates/Create');
    }
    ...
    public function store(SubordinateRequest $request)
    {
        ...
        return redirect()->route('staffs.subordinates.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Subordinate $subordinate)
    {
        ...
        return Inertia::render('Staff/Subordinates/Show', [
    ...
    {
        return Inertia::render('Staff/Subordinates/Edit', [
            'subordinate' => $subordinate
        ]);
    }
    ...
    public function update(SubordinateRequest $request, Subordinate $subordinate)
    {
        ...
        return redirect()->route('staffs.subordinates.index')->with('success', 'Record Updated');
    }
