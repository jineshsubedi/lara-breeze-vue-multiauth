...
class AdjustmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->get(['id', 'name']);
        return Inertia::render('Supervisor/Adjustments/Index', [
    ...
    {
        return Inertia::render('Supervisor/Adjustments/Create', [
            'categories' => Adjustmentreason::orderBy('title')->get(['id', 'title']),
    ...
    public function store(AdjustmentRequest $request)
    {
        ...
        return redirect()->route('supervisor.adjustments.index')->with('success', 'Adjustment Saved!');
    }
    ...
    public function show(Adjustment $adjustment)
    {
        ...
        return Inertia::render('Supervisor/Adjustments/Show', [
    ...
    {
        return Inertia::render('Supervisor/Adjustments/Edit', [
            'adjustment' => $adjustment,
            'staffs' => User::active()->branchId()->get(['id','name']),
            'categories' => Adjustmentreason::orderBy('title')->get(['id', 'title'])
        ]);
    ...
    public function update(AdjustmentRequest $request, Adjustment $adjustment)
    {
        ...
        return redirect()->route('supervisor.adjustments.index')->with('success', 'Record Updated');
    }
