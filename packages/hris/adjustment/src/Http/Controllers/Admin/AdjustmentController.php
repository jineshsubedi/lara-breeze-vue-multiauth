...
class AdjustmentController extends Controller
{
    ...
    public function store(AdjustmentRequest $request)
    {
        ...
        return redirect()->route('admin.adjustments.index')->with('success', 'Adjustment Saved!');
    }
    ...
    public function show(Adjustment $adjustment)
    {
        ...
        return Inertia::render('Admin/Adjustments/Show', [
    ...
    {
        return Inertia::render('Admin/Adjustments/Edit', [
            'adjustment' => $adjustment,
            'staffs' => User::active()->branchId()->get(['id','name']),
            'categories' => Adjustmentreason::orderBy('title')->get(['id', 'title'])
        ]);
    ...
    public function update(AdjustmentRequest $request, Adjustment $adjustment)
    {
        ...
        return redirect()->route('admin.adjustments.index')->with('success', 'Record Updated');
    }
