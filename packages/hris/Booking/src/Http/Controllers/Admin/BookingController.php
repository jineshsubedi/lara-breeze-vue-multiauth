...
class BookingController extends Controller
{
    ...
    public function store(BookingRequest $request)
    {
        ...
        return redirect()->route('admin.bookings.index')->with('success', 'Record Added!');
    }
    ...
    public function update(BookingRequest $request, Booking $booking)
    {
        ...
        return redirect()->route('admin.bookings.index')->with('success', 'Record Updated');
    }
    ...
    public function getParticipants($id)
    {
        ...
        return Inertia::render('Admin/Bookings/Members',[
            'booking' => $booking,
    ...
    private function staffUrl($user, $id)
    {
        ...
        {
            return route('admin.bookings.show', $id);
        }
