...
class BookingPurposeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/BookingPurposes/Index', [
    ...
    {
        return Inertia::render('Admin/BookingPurposes/Create');
    }
    ...
    public function store(BookingPurposeRequest $request)
    {
        ...
        return redirect()->route('admin.bookingpurposes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/BookingPurposes/Edit', [
    ...
    public function update(BookingPurposeRequest $request, BookingPurpose $bookingpurpose)
    {
        ...
        return redirect()->route('admin.bookingpurposes.index')->with('success', 'Record Updated');
    }
