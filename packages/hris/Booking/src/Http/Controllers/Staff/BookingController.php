...
class BookingController extends Controller
{
    ...
    {
        return Inertia::render('Staff/Bookings/Edit', [
            'booking' => $booking,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(BookingRequest $request, Booking $booking)
    {
        ...
        return redirect()->route('staffs.bookings.index')->with('success', 'Record Updated');
    }
    ...
    public function getParticipants($id)
    {
        ...
        return Inertia::render('Staff/Bookings/Members',[
            'booking' => $booking,
