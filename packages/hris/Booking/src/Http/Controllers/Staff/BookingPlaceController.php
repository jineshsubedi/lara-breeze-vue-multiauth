...
class BookingPlaceController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/BookingPlaces/Index', [
    ...
    {
        return Inertia::render('Staff/BookingPlaces/Create');
    }
    ...
    public function store(BookingPlaceRequest $request)
    {
        ...
        return redirect()->route('staffs.bookingplaces.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/BookingPlaces/Edit', [
    ...
    public function update(BookingPlaceRequest $request, BookingPlace $bookingplace)
    {
        ...
        return redirect()->route('staffs.bookingplaces.index')->with('success', 'Record Updated');
    }
