...
class BookingHallController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Staff/BookingHalls/Index', [
    ...
    {
        return Inertia::render('Staff/BookingHalls/Create',[
            'bookingplaces' => BookingPlace::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function store(BookingHallRequest $request)
    {
        ...
        return redirect()->route('staffs.bookinghalls.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/BookingHalls/Edit', [
    ...
    public function update(BookingHallRequest $request, BookingHall $bookinghall)
    {
        ...
        return redirect()->route('staffs.bookinghalls.index')->with('success', 'Record Updated');
    }
