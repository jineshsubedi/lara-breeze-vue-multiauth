...
class BookingPurposeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/BookingPurposes/Index', [
    ...
    {
        return Inertia::render('Supervisor/BookingPurposes/Create');
    }
    ...
    public function store(BookingPurposeRequest $request)
    {
        ...
        return redirect()->route('supervisor.bookingpurposes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/BookingPurposes/Edit', [
    ...
    public function update(BookingPurposeRequest $request, BookingPurpose $bookingpurpose)
    {
        ...
        return redirect()->route('supervisor.bookingpurposes.index')->with('success', 'Record Updated');
    }
