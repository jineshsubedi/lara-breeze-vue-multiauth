...
class BookingHallController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Supervisor/BookingHalls/Index', [
    ...
    {
        return Inertia::render('Supervisor/BookingHalls/Create',[
            'bookingplaces' => BookingPlace::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function store(BookingHallRequest $request)
    {
        ...
        return redirect()->route('supervisor.bookinghalls.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/BookingHalls/Edit', [
    ...
    public function update(BookingHallRequest $request, BookingHall $bookinghall)
    {
        ...
        return redirect()->route('supervisor.bookinghalls.index')->with('success', 'Record Updated');
    }
