...
class BookingPlaceController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/BookingPlaces/Index', [
    ...
    {
        return Inertia::render('Supervisor/BookingPlaces/Create');
    }
    ...
    public function store(BookingPlaceRequest $request)
    {
        ...
        return redirect()->route('supervisor.bookingplaces.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/BookingPlaces/Edit', [
    ...
    public function update(BookingPlaceRequest $request, BookingPlace $bookingplace)
    {
        ...
        return redirect()->route('supervisor.bookingplaces.index')->with('success', 'Record Updated');
    }
