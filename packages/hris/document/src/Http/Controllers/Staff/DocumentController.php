...
class DocumentController extends Controller
{
    ...
    public function create()
    {
        ...
        return Inertia::render('Staff/Document/Create',[
            'branches' => $branches
        ]);
    }
    ...
    public function store(DocumentRequest $request)
    {
        ...
        return redirect()->route('staffs.documents.index')->with('success', 'Document Added Successfully!');
    }
    ...
    {
        return Inertia::render('Staff/Document/Edit', [
            'document' => $document
        ]);
    }
    ...
    public function update(DocumentRequest $request, Document $document)
    {
        ...
        return redirect()->route('staffs.documents.index')->with('success', 'Document Updated Successfully!');
    }
