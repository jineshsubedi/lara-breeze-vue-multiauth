...
class EventController extends Controller
{
    ...
    public function store(EventRequest $request)
    {
        ...
        return redirect()->route('staffs.events.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Events/Edit', [
            'event' => $event,
            'branches' => Branch::branchList(),
        ]);
    }
    ...
    public function update(EventRequest $request, Event $event)
    {
        ...
        $this->updateAttachments($event);
        return redirect()->route('staffs.events.index')->with('success', 'Record Updated');
    }
