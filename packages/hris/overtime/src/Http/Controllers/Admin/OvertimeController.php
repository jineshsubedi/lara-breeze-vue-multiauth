...
class OvertimeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->get(['id', 'name']);
        return Inertia::render('Admin/Overtimes/Index', [
            'overtimes' => $overtimes,
            'staffs' => $staffs,
    ...
    {
        return Inertia::render('Admin/Overtimes/Create', [
            'categories' => Overtimereason::orderBy('title')->get(['id', 'title']),
    ...
    public function store(OvertimeRequest $request)
    {
        ...
        return redirect()->route('admin.overtimes.index')->with('success', 'Overtime Saved!');
    }
    ...
    public function show(Overtime $overtime)
    {
        ...
        return Inertia::render('Admin/Overtimes/Show', [
            'overtime' => $overtime,
    ...
    {
        return Inertia::render('Admin/Overtimes/Edit', [
            'overtime' => $overtime,
            'staffs' => User::active()->branchId()->get(['id','name']),
            'categories' => Overtimereason::orderBy('title')->get(['id', 'title']),
            'holidays' => AppConstant::YN
    ...
    public function update(OvertimeRequest $request, Overtime $overtime)
    {
        ...
        return redirect()->route('admin.overtimes.index')->with('success', 'Record Updated');
    }
