...
class OvertimereasonController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Overtimereasons/Index', [
    ...
    {
        return Inertia::render('Staff/Overtimereasons/Create');
    }
    ...
    public function store(OvertimereasonRequest $request)
    {
        ...
        return redirect()->route('staffs.overtimereasons.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Overtimereasons/Edit', [
    ...
    public function update(OvertimereasonRequest $request, Overtimereason $overtimereason)
    {
        ...
        return redirect()->route('staffs.overtimereasons.index')->with('success', 'Record Updated');
    }
