...
class OffboardSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/Setting/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/Setting/Create', [
    ...
    public function store(OffboardSettingRequest $request)
    {
        ...
        return redirect()->route('staffs.offboardsettings.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Offboard/Setting/Edit', [
    ...
    public function update(OffboardSettingRequest $request, OffboardSetting $offboardsetting)
    {
        ...
        return redirect()->route('staffs.offboardsettings.index')->with('success', 'Record Updated');
    }
