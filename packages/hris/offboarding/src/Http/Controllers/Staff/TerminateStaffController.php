...
class TerminateStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/TerminationStaffs/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/TerminationStaffs/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(TerminateStaffRequest $request)
    {
        ...
        return redirect()->route('staffs.terminatestaffs.index')->with('success', 'Record Added!');
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Staff/Offboard/TerminationStaffs/Show', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Staff/Offboard/TerminationStaffs/Edit', [
            'terminationstaff' => $terminationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(TerminateStaffRequest $request, $id)
    {
        ...
        return redirect()->route('staffs.terminatestaffs.index')->with('success', 'Record Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('staffs.terminatestaffs.index')->with('success', 'Record Deleted!');
    }
