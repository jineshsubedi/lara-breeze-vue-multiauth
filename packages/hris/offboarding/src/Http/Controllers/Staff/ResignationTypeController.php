...
class ResignationTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/ResignationTypes/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/ResignationTypes/Create');
    }
    ...
    public function store(ResignationTypeRequest $request)
    {
        ...
        return redirect()->route('staffs.resignationtypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Offboard/ResignationTypes/Edit', [
    ...
    public function update(ResignationTypeRequest $request, ResignationType $resignationtype)
    {
        ...
        return redirect()->route('staffs.resignationtypes.index')->with('success', 'Record Updated');
    }
