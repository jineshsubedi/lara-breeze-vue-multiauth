...
class TerminationTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/TerminationTypes/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/TerminationTypes/Create');
    }
    ...
    public function store(TerminationTypeRequest $request)
    {
        ...
        return redirect()->route('staffs.terminationtypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Offboard/TerminationTypes/Edit', [
    ...
    public function update(TerminationTypeRequest $request, TerminationType $terminationtype)
    {
        ...
        return redirect()->route('staffs.terminationtypes.index')->with('success', 'Record Updated');
    }
