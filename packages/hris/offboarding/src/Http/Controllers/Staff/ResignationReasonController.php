...
class ResignationReasonController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/ResignationReasons/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/ResignationReasons/Create');
    }
    ...
    public function store(ResignationReasonRequest $request)
    {
        ...
        return redirect()->route('staffs.resignationreasons.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Offboard/ResignationReasons/Edit', [
    ...
    public function update(ResignationReasonRequest $request, ResignationReason $resignationreason)
    {
        ...
        return redirect()->route('staffs.resignationreasons.index')->with('success', 'Record Updated');
    }
