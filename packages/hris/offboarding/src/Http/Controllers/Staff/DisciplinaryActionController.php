...
class DisciplinaryActionController extends Controller
{
    ...
    public function index()
    {
        ...
        $disciplinaryactions = $filter->latest('id', 'desc')
                          ->paginate(20)
                          ->withQueryString();
        return Inertia::render('Staff/Offboard/DisciplinaryActions/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/DisciplinaryActions/Create',[
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function store(DisciplinaryActionRequest $request)
    {
        ...
        return redirect()->route('staffs.disciplinaryactions.index')->with('success', 'Record Added!');
    }
    ...
    public function show(DisciplinaryAction $disciplinaryaction)
    {
        ...
        return Inertia::render('Staff/Offboard/DisciplinaryActions/Show', [
    ...
    public function edit(DisciplinaryAction $disciplinaryaction)
    {
        ...
        return Inertia::render('Staff/Offboard/DisciplinaryActions/Edit', [
            'disciplinaryaction' => $disciplinaryaction,
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function update(DisciplinaryActionRequest $request, DisciplinaryAction $disciplinaryaction)
    {
        ...
        return redirect()->route('staffs.disciplinaryactions.index')->with('success', 'Record Updated');
    }
