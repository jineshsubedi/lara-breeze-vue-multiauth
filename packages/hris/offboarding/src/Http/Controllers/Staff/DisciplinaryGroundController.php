...
class DisciplinaryGroundController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/DisciplinaryGrounds/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/DisciplinaryGrounds/Create');
    }
    ...
    public function store(DisciplinaryGroundRequest $request)
    {
        ...
        return redirect()->route('staffs.disciplinarygrounds.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Offboard/DisciplinaryGrounds/Edit', [
    ...
    public function update(DisciplinaryGroundRequest $request, DisciplinaryGround $disciplinaryground)
    {
        ...
        return redirect()->route('staffs.disciplinarygrounds.index')->with('success', 'Record Updated');
    }
