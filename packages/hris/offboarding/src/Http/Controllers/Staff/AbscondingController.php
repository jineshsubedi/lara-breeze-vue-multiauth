...
class AbscondingController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Offboard/Abscondings/Index', [
    ...
    {
        return Inertia::render('Staff/Offboard/Abscondings/Create', [
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function store(AbscondingRequest $request)
    {
        ...
        return redirect()->route('staffs.abscondings.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Absconding $absconding)
    {
        ...
        return Inertia::render('Staff/Offboard/Abscondings/Show', [
    ...
    public function edit(Absconding $absconding)
    {
        ...
        return Inertia::render('Staff/Offboard/Abscondings/Edit', [
            'absconding' => $absconding,
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function update(AbscondingRequest $request, Absconding $absconding)
    {
        ...
        return redirect()->route('staffs.abscondings.index')->with('success', 'Record Updated');
    }
