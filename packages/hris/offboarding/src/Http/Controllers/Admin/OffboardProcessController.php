...
class OffboardProcessController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/Process/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/Process/Create',[
    ...
    public function store(OffboardProcessRequest $request)
    {
        ...
        return redirect()->route('admin.offboardprocesses.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Offboard/Process/Edit', [
    ...
    public function update(OffboardProcessRequest $request, OffboardProcess $offboardprocess)
    {
        ...
        return redirect()->route('admin.offboardprocesses.index')->with('success', 'Record Updated');
    }
