...
class DisciplinaryGroundController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/DisciplinaryGrounds/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/DisciplinaryGrounds/Create');
    }
    ...
    public function store(DisciplinaryGroundRequest $request)
    {
        ...
        return redirect()->route('admin.disciplinarygrounds.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Offboard/DisciplinaryGrounds/Edit', [
    ...
    public function update(DisciplinaryGroundRequest $request, DisciplinaryGround $disciplinaryground)
    {
        ...
        return redirect()->route('admin.disciplinarygrounds.index')->with('success', 'Record Updated');
    }
