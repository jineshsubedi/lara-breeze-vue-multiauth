...
class OffboardSettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/Setting/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/Setting/Create', [
    ...
    public function store(OffboardSettingRequest $request)
    {
        ...
        return redirect()->route('admin.offboardsettings.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Offboard/Setting/Edit', [
    ...
    public function update(OffboardSettingRequest $request, OffboardSetting $offboardsetting)
    {
        ...
        return redirect()->route('admin.offboardsettings.index')->with('success', 'Record Updated');
    }
