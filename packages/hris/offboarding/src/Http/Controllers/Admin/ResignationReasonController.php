...
class ResignationReasonController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/ResignationReasons/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/ResignationReasons/Create');
    }
    ...
    public function store(ResignationReasonRequest $request)
    {
        ...
        return redirect()->route('admin.resignationreasons.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Admin/Offboard/ResignationReasons/Edit', [
    ...
    public function update(ResignationReasonRequest $request, ResignationReason $resignationreason)
    {
        ...
        return redirect()->route('admin.resignationreasons.index')->with('success', 'Record Updated');
    }
