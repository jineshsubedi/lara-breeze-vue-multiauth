...
class TerminateStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/TerminationStaffs/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/TerminationStaffs/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(TerminateStaffRequest $request)
    {
        ...
        return redirect()->route('admin.terminatestaffs.index')->with('success', 'Record Added!');
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Admin/Offboard/TerminationStaffs/Show', [
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Admin/Offboard/TerminationStaffs/Edit', [
            'terminationstaff' => $terminationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(TerminateStaffRequest $request, $id)
    {
        ...
        return redirect()->route('admin.terminatestaffs.index')->with('success', 'Record Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.terminatestaffs.index')->with('success', 'Record Deleted!');
    }
