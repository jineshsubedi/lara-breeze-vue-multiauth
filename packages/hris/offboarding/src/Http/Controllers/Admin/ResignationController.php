...
class ResignationController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/Resignation/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/Resignation/Create', [
            'datas' => $this->getData(),
            'user_id' => auth()->id()
        ]);
    }
    ...
    public function store(ResignationStaffRequest $request)
    {
        ...
        return redirect()->route('admin.resignations.index')->with('success', 'Record Added!');
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Admin/Offboard/Resignation/Show', [
    ...
    {
        $resignationstaff = ResignationStaff::findOrFail($id);
        return Inertia::render('Admin/Offboard/Resignation/Edit', [
            'resignationstaff' => $resignationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(ResignationStaffRequest $request, $id)
    {
        ...
        return redirect()->route('admin.resignations.index')->with('success', 'Record Updated');
    }
