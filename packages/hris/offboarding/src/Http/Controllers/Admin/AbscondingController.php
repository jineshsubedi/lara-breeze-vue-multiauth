...
class AbscondingController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/Abscondings/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/Abscondings/Create', [
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function store(AbscondingRequest $request)
    {
        ...
        return redirect()->route('admin.abscondings.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Absconding $absconding)
    {
        ...
        return Inertia::render('Admin/Offboard/Abscondings/Show', [
    ...
    public function edit(Absconding $absconding)
    {
        ...
        return Inertia::render('Admin/Offboard/Abscondings/Edit', [
            'absconding' => $absconding,
            'datas' => $this->getData(),
        ]);
    }
    ...
    public function update(AbscondingRequest $request, Absconding $absconding)
    {
        ...
        return redirect()->route('admin.abscondings.index')->with('success', 'Record Updated');
    }
