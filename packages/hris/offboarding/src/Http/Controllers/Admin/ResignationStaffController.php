...
class ResignationStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Offboard/ResignationStaffs/Index', [
    ...
    {
        return Inertia::render('Admin/Offboard/ResignationStaffs/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(ResignationStaffRequest $request)
    {
        ...
        return redirect()->route('admin.resignationstaffs.index')->with('success', 'Record Added!');
    }
    ...
    public function show(ResignationStaff $resignationstaff)
    {
        ...
        return Inertia::render('Admin/Offboard/ResignationStaffs/Show', [
    ...
    {
        return Inertia::render('Admin/Offboard/ResignationStaffs/Edit', [
            'resignationstaff' => $resignationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(ResignationStaffRequest $request, ResignationStaff $resignationstaff)
    {
        ...
        return redirect()->route('admin.resignationstaffs.index')->with('success', 'Record Updated');
    }
