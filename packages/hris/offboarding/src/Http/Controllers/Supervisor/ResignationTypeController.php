...
class ResignationTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Offboard/ResignationTypes/Index', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/ResignationTypes/Create');
    }
    ...
    public function store(ResignationTypeRequest $request)
    {
        ...
        return redirect()->route('supervisor.resignationtypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Offboard/ResignationTypes/Edit', [
    ...
    public function update(ResignationTypeRequest $request, ResignationType $resignationtype)
    {
        ...
        return redirect()->route('supervisor.resignationtypes.index')->with('success', 'Record Updated');
    }
