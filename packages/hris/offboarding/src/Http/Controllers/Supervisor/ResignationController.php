...
class ResignationController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Offboard/Resignation/Index', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/Resignation/Create', [
            'datas' => $this->getData(),
            'user_id' => auth()->id()
        ]);
    }
    ...
    public function store(ResignationStaffRequest $request)
    {
        ...
        return redirect()->route('supervisor.resignations.index')->with('success', 'Record Added!');
    }
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Supervisor/Offboard/Resignation/Show', [
    ...
    {
        $resignationstaff = ResignationStaff::findOrFail($id);
        return Inertia::render('Supervisor/Offboard/Resignation/Edit', [
            'resignationstaff' => $resignationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(ResignationStaffRequest $request, $id)
    {
        ...
        return redirect()->route('supervisor.resignations.index')->with('success', 'Record Updated');
    }
