...
class OffboardProcessController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Offboard/Process/Index', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/Process/Create',[
    ...
    public function store(OffboardProcessRequest $request)
    {
        ...
        return redirect()->route('supervisor.offboardprocesses.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Offboard/Process/Edit', [
    ...
    public function update(OffboardProcessRequest $request, OffboardProcess $offboardprocess)
    {
        ...
        return redirect()->route('supervisor.offboardprocesses.index')->with('success', 'Record Updated');
    }
