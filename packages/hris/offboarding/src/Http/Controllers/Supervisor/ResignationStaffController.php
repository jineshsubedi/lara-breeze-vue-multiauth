...
class ResignationStaffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Offboard/ResignationStaffs/Index', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/ResignationStaffs/Create', [
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(ResignationStaffRequest $request)
    {
        ...
        return redirect()->route('supervisor.resignationstaffs.index')->with('success', 'Record Added!');
    }
    ...
    public function show(ResignationStaff $resignationstaff)
    {
        ...
        return Inertia::render('Supervisor/Offboard/ResignationStaffs/Show', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/ResignationStaffs/Edit', [
            'resignationstaff' => $resignationstaff,
            'datas' => $this->getData()
        ]);
    }
    ...
    public function update(ResignationStaffRequest $request, ResignationStaff $resignationstaff)
    {
        ...
        return redirect()->route('supervisor.resignationstaffs.index')->with('success', 'Record Updated');
    }
