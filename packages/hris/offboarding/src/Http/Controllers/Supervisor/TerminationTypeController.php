...
class TerminationTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Offboard/TerminationTypes/Index', [
    ...
    {
        return Inertia::render('Supervisor/Offboard/TerminationTypes/Create');
    }
    ...
    public function store(TerminationTypeRequest $request)
    {
        ...
        return redirect()->route('supervisor.terminationtypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Offboard/TerminationTypes/Edit', [
    ...
    public function update(TerminationTypeRequest $request, TerminationType $terminationtype)
    {
        ...
        return redirect()->route('supervisor.terminationtypes.index')->with('success', 'Record Updated');
    }
