...
class TrainingController extends Controller
{
    ...
    public function store(TrainingRequest $request)
    {
        ...
        return redirect()->route('admin.trainings.index')->with('success', 'Record Added!');
    }
    ...
    public function update(TrainingRequest $request, Training $training)
    {
        ...
        return redirect()->route('admin.trainings.index')->with('success', 'Record Updated');
    }
    ...
    public function participants($id)
    {
        ...
        return Inertia::render('Admin/Trainings/Participant', [
            'training' => $training,
            'participants' => $participants
        ]);
    }
    ...
    public function getMaterials($id)
    {
        ...
        return Inertia::render('Admin/Trainings/Attachment', [
            'training' => $training,
            'materials' => $materials,
        ]);
    }
    ...
    public function getCosts($id)
    {
        ...
        return Inertia::render('Admin/Trainings/Cost', [
            'training' => $training,
            'costs' => $costs,
        ]);
    }
