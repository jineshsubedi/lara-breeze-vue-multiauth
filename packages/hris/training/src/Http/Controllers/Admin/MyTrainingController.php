...
class MyTrainingController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('Admin/Mytrainings/Index', [
    ...
    public function show($id)
    {
        ...
        $participants = TrainingParticipant::with(['user:id,name'])
            ...
            ->latest()
            ->get();
        return Inertia::render('Admin/Mytrainings/Show', [
            'training' => $training,
    ...
    public function evaluationForm($id)
    {
        ...
        $questions = TrainingTemplateQuestion::where('training_template_id', $template->id)
                ->orderBy('order')
                ->get();
        return Inertia::render('Admin/Mytrainings/Evaluation', [
            'template' => $template,
            'questions' => $questions,
    ...
    public function saveEvaluationForm($id, Request $request)
    {
        ...
        return redirect()->route('admin.mytrainings.index', ['type'=>'evaluation'])->with('success', 'Form Submitted Successfully');
    }
