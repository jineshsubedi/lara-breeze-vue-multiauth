...
class TrainerController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Trainers/Index', [
            'trainers' => $trainers,
    ...
    {
        return Inertia::render('Supervisor/Trainers/Create',[
    ...
    public function store(TrainerRequest $request)
    {
        ...
        return redirect()->route('supervisor.trainers.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Trainers/Show', [
            'trainer' => $trainer,
        ]);
    }
    ...
    {
        return Inertia::render('Supervisor/Trainers/Edit', [
            'trainer' => $trainer,
            'types' => config('trainingConstant.types')
        ]);
    }
    ...
    public function update(TrainerRequest $request, Trainer $trainer)
    {
        ...
        return redirect()->route('supervisor.trainers.index')->with('success', 'Record Updated');
    }
