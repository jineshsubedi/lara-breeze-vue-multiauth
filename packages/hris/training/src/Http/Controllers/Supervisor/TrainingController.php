...
class TrainingController extends Controller
{
    ...
    {
        return Inertia::render('Supervisor/Trainings/Create',[
            'datas' => $this->getData()
        ]);
    }
    ...
    public function store(TrainingRequest $request)
    {
        ...
        return redirect()->route('supervisor.trainings.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Training $training)
    {
        ...
        $participants = TrainingParticipant::with(['user:id,name'])
            ...
            ->latest()
            ->get();
        return Inertia::render('Supervisor/Trainings/Show', [
            'training' => $training,
    ...
    public function edit(Training $training)
    {
        ...
        return Inertia::render('Supervisor/Trainings/Edit', [
            'training' => $training,
    ...
    public function update(TrainingRequest $request, Training $training)
    {
        ...
        return redirect()->route('supervisor.trainings.index')->with('success', 'Record Updated');
    }
    ...
    public function participants($id)
    {
        ...
        return Inertia::render('Supervisor/Trainings/Participant', [
            'training' => $training,
            'participants' => $participants
        ]);
    }
    ...
    public function getMaterials($id)
    {
        ...
        return Inertia::render('Supervisor/Trainings/Attachment', [
            'training' => $training,
            'materials' => $materials,
        ]);
    }
    ...
    public function getCosts($id)
    {
        ...
        return Inertia::render('Supervisor/Trainings/Cost', [
            'training' => $training,
            'costs' => $costs,
        ]);
    }
