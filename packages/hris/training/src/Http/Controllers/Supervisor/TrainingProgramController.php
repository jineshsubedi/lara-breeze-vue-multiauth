...
class TrainingProgramController extends Controller
{
    ...
    public function index()
    {
        ...
        $trainingprograms = $filter->orderBy('title')
                          ->paginate(20)
                          ->withQueryString();
        return Inertia::render('Supervisor/TrainingPrograms/Index', [
    ...
    {
        return Inertia::render('Supervisor/TrainingPrograms/Create');
    }
    ...
    public function store(TrainingProgramRequest $request)
    {
        ...
        return redirect()->route('supervisor.trainingprograms.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/TrainingPrograms/Edit', [
    ...
    public function update(TrainingProgramRequest $request, TrainingProgram $trainingprogram)
    {
        ...
        return redirect()->route('supervisor.trainingprograms.index')->with('success', 'Record Updated');
    }
