...
class ExitInterviewController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/ExitInterviews/Index', [
    ...
    {
        return Inertia::render('Admin/ExitInterviews/Create',[
    ...
    public function store(ExitInterviewRequest $request)
    {
        ...
        return redirect()->route('admin.exitinterviews.index')->with('success', 'Record Added!');
    }
    ...
    public function show(ExitInterview $exitinterview)
    {
        ...
        return Inertia::render('Admin/ExitInterviews/Show',[
    ...
    {
        return Inertia::render('Admin/ExitInterviews/Edit', [
            'exitinterview' => $exitinterview
        ]);
    }
    ...
    public function update(ExitInterviewRequest $request, ExitInterview $exitinterview)
    {
        ...
        return redirect()->route('admin.exitinterviews.index')->with('success', 'Record Updated');
    }
