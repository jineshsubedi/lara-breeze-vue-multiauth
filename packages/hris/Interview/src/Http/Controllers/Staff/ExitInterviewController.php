...
class ExitInterviewController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/ExitInterviews/Index', [
    ...
    {
        return Inertia::render('Staff/ExitInterviews/Create',[
    ...
    public function store(ExitInterviewRequest $request)
    {
        ...
        return redirect()->route('staffs.exitinterviews.index')->with('success', 'Record Added!');
    }
    ...
    public function show(ExitInterview $exitinterview)
    {
        ...
        return Inertia::render('Staff/ExitInterviews/Show',[
    ...
    {
        return Inertia::render('Staff/ExitInterviews/Edit', [
            'exitinterview' => $exitinterview
        ]);
    }
    ...
    public function update(ExitInterviewRequest $request, ExitInterview $exitinterview)
    {
        ...
        return redirect()->route('staffs.exitinterviews.index')->with('success', 'Record Updated');
    }
