...
class DivisionController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/Divisions/Index', [
            'divisions' => $divisions
        ]);
    ...
    {
        return Inertia::render('Staff/Divisions/Create');
    }
    ...
    public function store(DivisionRequest $request)
    {
        ...
        return redirect()->route('staffs.divisions.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Divisions/Edit', [
            'division' => $division
        ]);
    }
    ...
    public function update(DivisionRequest $request, Division $division)
    {
        ...
        return redirect()->route('staffs.divisions.index')->with('success', 'Record Updated');
    }
