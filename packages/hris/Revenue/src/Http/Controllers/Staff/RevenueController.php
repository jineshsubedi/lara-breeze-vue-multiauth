...
class RevenueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Staff/Revenues/Index', [
            'revenues' => $revenues,
    ...
    {
        return Inertia::render('Staff/Revenues/Create',[
            'divisions' => Division::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function store(RevenueRequest $request)
    {
        ...
        return redirect()->route('staffs.revenues.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Revenues/Edit', [
            'revenue' => $revenue,
            'divisions' => Division::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function update(RevenueRequest $request, Revenue $revenue)
    {
        ...
        return redirect()->route('staffs.revenues.index')->with('success', 'Record Updated');
    }
