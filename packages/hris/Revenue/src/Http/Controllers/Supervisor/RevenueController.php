...
class RevenueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Supervisor/Revenues/Index', [
            'revenues' => $revenues,
    ...
    {
        return Inertia::render('Supervisor/Revenues/Create',[
            'divisions' => Division::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function store(RevenueRequest $request)
    {
        ...
        return redirect()->route('supervisor.revenues.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Revenues/Edit', [
            'revenue' => $revenue,
            'divisions' => Division::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function update(RevenueRequest $request, Revenue $revenue)
    {
        ...
        return redirect()->route('supervisor.revenues.index')->with('success', 'Record Updated');
    }
