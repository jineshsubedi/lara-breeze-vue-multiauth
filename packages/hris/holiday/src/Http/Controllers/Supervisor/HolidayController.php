...
class HolidayController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Supervisor/Holiday/Index', [
    ...
    public function create()
    {
        $branches = Branch::branchList();
        $defBranch = auth()->user()->branch_id;
        return Inertia::render('Supervisor/Holiday/Create', [
            'branches' => fn () => $branches,
            'defBranch' => fn () => $defBranch,
        ]);
    }
    ...
    public function store(HolidayRequest $request)
    {
        ...
        return redirect()->route('supervisor.holidays.index')->with('success', 'Holiday Added Successfully');
    }
    ...
    public function edit(Holiday $holiday)
    {
        $branches = Branch::branchList();
        $defBranch = auth()->user()->branch_id;
        return Inertia::render('Supervisor/Holiday/Edit', [
            'holiday' => fn () => $holiday,
            'branches' => fn () => $branches,
            'defBranch' => fn () => $defBranch,
        ]);
    ...
    public function update(HolidayRequest $request, Holiday $holiday)
    {
        ...
        return redirect()->route('supervisor.holidays.index')->with('success', 'Holiday Updated Successfully');
    }
    ...
    {
        $holiday->delete();
        return redirect()->route('supervisor.holidays.index')->with('success', 'Holiday Deleted Successfully');
    }
