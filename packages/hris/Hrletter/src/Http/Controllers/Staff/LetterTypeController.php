...
class LetterTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staff/LetterTypes/Index', [
    ...
    {
        return Inertia::render('Staff/LetterTypes/Create');
    }
    ...
    public function store(LetterTypeRequest $request)
    {
        ...
        return redirect()->route('staffs.lettertypes.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/LetterTypes/Edit', [
    ...
    public function update(LetterTypeRequest $request, LetterType $lettertype)
    {
        ...
        return redirect()->route('staffs.lettertypes.index')->with('success', 'Record Updated');
    }
