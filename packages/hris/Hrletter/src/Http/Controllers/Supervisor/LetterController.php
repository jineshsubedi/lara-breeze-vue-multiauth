...
class LetterController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Letters/Index', [
            'letters' => $letters,
    ...
    {
        return Inertia::render('Supervisor/Letters/Create',[
            'types' => LetterType::orderBy('title')->get(['id', 'title']),
            'branches' => Branch::branchList(),
    ...
    public function store(LetterRequest $request)
    {
        ...
        return redirect()->route('supervisor.letters.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Supervisor/Letters/Edit', [
            'letter' => $letter,
            'types' => LetterType::orderBy('title')->get(['id', 'title']),
            'branches' => Branch::branchList(),
        ]);
    ...
    public function update(LetterRequest $request, Letter $letter)
    {
        ...
        $letter->update($request->validated());
        return redirect()->route('supervisor.letters.index')->with('success', 'Record Updated');
    }
    ...
    {
        $user = auth()->user();
        return Inertia::render('Supervisor/Letters/Generate', [
            'letters' => Letter::with(['type:id,title'])->where('branch_id', $user->branch_id)
