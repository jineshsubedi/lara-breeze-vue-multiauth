...
class SuggestionForController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Suggestionfor/Index', [
    ...
    {
        return Inertia::render('Admin/Suggestionfor/Create');
    }
    ...
    public function store(SuggestionForRequest $request)
    {
        ...
        return redirect()->route('admin.suggestionfor.index')->with('success', 'Suggestion Category Added Successfully!');
    }
    ...
    {
        return Inertia::render('Admin/Suggestionfor/Edit', [
    ...
    public function update(SuggestionForRequest $request, SuggestionFor $suggestionfor)
    {
        ...
        return redirect()->route('admin.suggestionfor.index')->with('success', 'Suggetion Category Updated Successfully!');
    }
