...
class SuggestionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Staff/Suggestion/Index', [
            'staffs' => $staffs,
            'branches' => $branches,
            'defBranch' => $defBranch,
    ...
    public function create()
    {
        ...
        return Inertia::render('Staff/Suggestion/Create', [
            'categories' => $categories,
            'options' => $options
        ]);
    }
    ...
    public function store(SuggestionRequest $request)
    {
        ...
        return redirect()->route('staffs.suggestions.index')->with('Suggestion Added Successfully');
    }
    ...
    public function show(SuggestionBox $suggestion)
    {
        ...
        return Inertia::render('Staff/Suggestion/Show', [
