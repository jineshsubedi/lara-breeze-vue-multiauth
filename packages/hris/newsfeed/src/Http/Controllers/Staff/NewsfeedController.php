...
class NewsfeedController extends Controller
{
    ...
    {
        return Inertia::render('Staff/Newsfeeds/Index', [
    ...
    public function store(NewsfeedRequest $request)
    {
        ...
        return redirect()->route('staffs.newsfeeds.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Newsfeed $newsfeed)
    {
        ...
        return Inertia::render('Staff/Newsfeeds/Show', [
            'newsfeed' => $newsfeed
        ]);
    }
    ...
    public function destroy(Newsfeed $newsfeed)
    {
        ...
        $newsfeed->delete();
        return redirect()->route('staffs.newsfeeds.index')->with('success', 'Record Deleted');
    }
