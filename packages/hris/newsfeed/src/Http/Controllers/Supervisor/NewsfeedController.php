...
class NewsfeedController extends Controller
{
    ...
    {
        return Inertia::render('Supervisor/Newsfeeds/Index', [
    ...
    public function store(NewsfeedRequest $request)
    {
        ...
        return redirect()->route('supervisor.newsfeeds.index')->with('success', 'Record Added!');
    }
    ...
    public function show(Newsfeed $newsfeed)
    {
        ...
        return Inertia::render('Supervisor/Newsfeeds/Show', [
            'newsfeed' => $newsfeed
        ]);
    }
    ...
    public function destroy(Newsfeed $newsfeed)
    {
        ...
        $newsfeed->delete();
        return redirect()->route('supervisor.newsfeeds.index')->with('success', 'Record Deleted');
    }
