...
class CompensatoryOffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Supervisor/Compensatory/Index', [
    ...
    {
        $datas = $this->getData();
        return Inertia::render('Supervisor/Compensatory/Create',[
            'datas' => $datas
        ]);
    }
    ...
    public function store(CompensatoryRequest $request)
    {
        ...
        return redirect()->route('supervisor.compensatory.index')->with('success', 'Compensatory Added Successfully!');
    }
    ...
    {
        $datas = $this->getData();
        return Inertia::render('Supervisor/Compensatory/Edit', [
    ...
    public function update(CompensatoryRequest $request, CompensatoryOff $compensatory)
    {
        ...
        return redirect()->route('supervisor.compensatory.index')->with('success', 'Compensatory Updated Successfully!');
    }
