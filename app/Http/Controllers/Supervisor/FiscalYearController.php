...
class FiscalYearController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Supervisor/Fiscal/Index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('Supervisor/Fiscal/Create', [
            'cyears' => $cyears,
        ]);
    }
    ...
    public function store(FiscalYearRequest $request)
    {
        ...
        return redirect()->route('supervisor.fiscalyears.index')->with('success', 'Fiscal Year Added Successfully');
    }
    ...
    {
        $cyears = AppConstant::YN;
        return Inertia::render('Supervisor/Fiscal/Edit', [
    ...
    public function update(FiscalYearRequest $request, FiscalYear $fiscalyear)
    {
        ...
        return redirect()->route('supervisor.fiscalyears.index')->with('success', 'Fiscal Year Updated Successfully');
    }
