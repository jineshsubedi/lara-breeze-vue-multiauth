...
class DailyTaskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Supervisor/DailyTasks/Index', [
            'dtasks' => $dtasks,
            'kras' => $kras,
            'staffs' => $staffs,
    ...
    public function show(DailyTask $dailytask)
    {
        ...
        return Inertia::render('Supervisor/DailyTasks/Show', [
            'dailytask' => $dailytask,
        ]);
    }
    ...
    public function edit(DailyTask $dailytask)
    {
        ...
        $kras = UserKra::where('user_id', auth()->id())->get(['id', 'title']);
        return Inertia::render('Supervisor/DailyTasks/Edit', [
            'dailytask' => $dailytask,
            'kras' => $kras
        ]);
    }
    ...
    public function update(Request $request, DailyTask $dailytask)
    {
        ...
        return redirect()->route('supervisor.dailytasks.index')->with('success', 'Daily Task Updated Successfully');
    }
