...
class CompensatoryOffController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Admin/Compensatory/Index', [
    ...
    {
        $datas = $this->getData();
        return Inertia::render('Admin/Compensatory/Create',[
            'datas' => $datas
        ]);
    }
    ...
    public function store(CompensatoryRequest $request)
    {
        ...
        return redirect()->route('admin.compensatory.index')->with('success', 'Compensatory Added Successfully!');
    }
    ...
    {
        $datas = $this->getData();
        return Inertia::render('Admin/Compensatory/Edit', [
    ...
    public function update(CompensatoryRequest $request, CompensatoryOff $compensatory)
    {
        ...
        return redirect()->route('admin.compensatory.index')->with('success', 'Compensatory Updated Successfully!');
    }
