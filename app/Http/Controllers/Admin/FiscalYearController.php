...
class FiscalYearController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Fiscal/Index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('Admin/Fiscal/Create', [
            'cyears' => $cyears,
        ]);
    }
    ...
    public function store(FiscalYearRequest $request)
    {
        ...
        return redirect()->route('admin.fiscalyears.index')->with('success', 'Fiscal Year Added Successfully');
    }
    ...
    {
        $cyears = AppConstant::YN;
        return Inertia::render('Admin/Fiscal/Edit', [
    ...
    public function update(FiscalYearRequest $request, FiscalYear $fiscalyear)
    {
        ...
        return redirect()->route('admin.fiscalyears.index')->with('success', 'Fiscal Year Updated Successfully');
    }
