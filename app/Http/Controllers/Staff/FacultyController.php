...
class FacultyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Staff/Faculties/Index', [
            'faculties' => $faculties,
    ...
    {
        return Inertia::render('Staff/Faculties/Create',[
            'educations' => Education::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function store(FacultyRequest $request)
    {
        ...
        return redirect()->route('staffs.faculties.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Faculties/Edit', [
            'faculty' => $faculty,
            'educations' => Education::orderBy('title')->get(['id', 'title']),
        ]);
    }
    ...
    public function update(FacultyRequest $request, Faculty $faculty)
    {
        ...
        return redirect()->route('staffs.faculties.index')->with('success', 'Record Updated');
    }
