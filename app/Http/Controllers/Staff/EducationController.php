...
class EducationController extends Controller
{
    ...
    {
        return Inertia::render('Staff/Education/Create');
    }
    ...
    public function store(EducationRequest $request)
    {
        ...
        return redirect()->route('staffs.education.index')->with('success', 'Record Added!');
    }
    ...
    {
        return Inertia::render('Staff/Education/Edit', [
            'education' => $education
        ]);
    }
    ...
    public function update(EducationRequest $request, Education $education)
    {
        ...
        return redirect()->route('staffs.education.index')->with('success', 'Record Updated');
    }
